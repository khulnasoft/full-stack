...
Swagger UI: http://local.dockertoolbox.khulnasoft.com/swagger/

PGAdmin: http://local.dockertoolbox.khulnasoft.com:5050
...
Swagger UI: http://localhost.khulnasoft.com/swagger/
...
This project was generated using https://github.com/khulnasoft/full-stack with:

```bash
pip install cookiecutter
cookiecutter https://github.com/khulnasoft/full-stack
```
...
That would be useful if, for example, the project generator (`khulnasoft/full-stack`) was updated and you want to integrate or review the changes.
...
```bash
cookiecutter --config-file ./cookiecutter-config-file.yml --output-dir ../project-copy https://github.com/khulnasoft/full-stack
```
